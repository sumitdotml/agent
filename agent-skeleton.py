"""
LangGraph agent skeleton with:
    - Structured JSON actions
    - A THINK → TOOL → THINK → FINALIZE loop
    - Streaming timeline output
    - Calculator as a placeholder tool

Can be quickly adapted to other tools and models.

Just gotta copy this file inside the `agent/` directory and get going.
"""
